...
public class CurrencyDao extends AbstractDao<Currency, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Notation = new Property(2, String.class, "notation", false, "NOTATION");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CURRENCY\" (" + //
                ...
                "\"NOTATION\" TEXT NOT NULL );"); // 2: notation
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Currency entity) {
        ...
        stmt.bindString(3, entity.getNotation());
    }

    @Override
    protected void attachEntity(Currency entity) {
    ...
    public Currency readEntity(Cursor cursor, int offset) {
        Currency entity = new Currency( //
            ...
            cursor.getString(offset + 2) // notation
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Currency entity, int offset) {
        ...
        entity.setNotation(cursor.getString(offset + 2));
     }
